...
# 定义要执行的脚本列表（按顺序执行）
SCRIPTS=(
    "scripts/Timer1/few-shot/Timer1_ECL.sh"
    "scripts/Timer1/few-shot/Timer1_ETTh1.sh"
    "scripts/Timer1/few-shot/Timer1_ETTh2.sh"
    "scripts/Timer1/few-shot/Timer1_ETTm1.sh"
    "scripts/Timer1/few-shot/Timer1_ETTm2.sh"
    "scripts/Timer1/few-shot/Timer1_Exchange.sh"
    "scripts/Timer1/few-shot/Timer1_Traffic.sh"
    "scripts/Timer1/few-shot/Timer1_Weather.sh"
)
