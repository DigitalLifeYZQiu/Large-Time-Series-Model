...
# 定义要执行的脚本列表（按顺序执行）
SCRIPTS=(
    "scripts/Timer-LOTSA/few-shot/Timer-LOTSA_ECL.sh"
    "scripts/Timer-LOTSA/few-shot/Timer-LOTSA_ETTh1.sh"
    "scripts/Timer-LOTSA/few-shot/Timer-LOTSA_ETTh2.sh"
    "scripts/Timer-LOTSA/few-shot/Timer-LOTSA_ETTm1.sh"
    "scripts/Timer-LOTSA/few-shot/Timer-LOTSA_ETTm2.sh"
    "scripts/Timer-LOTSA/few-shot/Timer-LOTSA_Exchange.sh"
    "scripts/Timer-LOTSA/few-shot/Timer-LOTSA_Traffic.sh"
    "scripts/Timer-LOTSA/few-shot/Timer-LOTSA_Weather.sh"
)
...
log_dir=logs/Timer_LOTSA/few-shot
