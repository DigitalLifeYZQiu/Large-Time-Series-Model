...
# 定义要执行的脚本列表（按顺序执行）
SCRIPTS=(
    "scripts/Timer-UTSD/few-shot/Timer-UTSD_ECL.sh"
    "scripts/Timer-UTSD/few-shot/Timer-UTSD_ETTh1.sh"
    "scripts/Timer-UTSD/few-shot/Timer-UTSD_ETTh2.sh"
    "scripts/Timer-UTSD/few-shot/Timer-UTSD_ETTm1.sh"
    "scripts/Timer-UTSD/few-shot/Timer-UTSD_ETTm2.sh"
    "scripts/Timer-UTSD/few-shot/Timer-UTSD_Exchange.sh"
    "scripts/Timer-UTSD/few-shot/Timer-UTSD_Traffic.sh"
    "scripts/Timer-UTSD/few-shot/Timer-UTSD_Weather.sh"
)
...
log_dir=logs/Timer_UTSD/few-shot
