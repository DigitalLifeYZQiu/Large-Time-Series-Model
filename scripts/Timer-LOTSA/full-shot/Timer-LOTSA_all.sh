...
# 定义要执行的脚本列表（按顺序执行）
SCRIPTS=(
    "scripts/Timer-LOTSA/Timer-LOTSA_ECL.sh"
    "scripts/Timer-LOTSA/Timer-LOTSA_ETTh1.sh"
    "scripts/Timer-LOTSA/Timer-LOTSA_ETTh2.sh"
    "scripts/Timer-LOTSA/Timer-LOTSA_ETTm1.sh"
    "scripts/Timer-LOTSA/Timer-LOTSA_ETTm2.sh"
    "scripts/Timer-LOTSA/Timer-LOTSA_Exchange.sh"
    "scripts/Timer-LOTSA/Timer-LOTSA_Traffic.sh"
    "scripts/Timer-LOTSA/Timer-LOTSA_Weather.sh"
)
