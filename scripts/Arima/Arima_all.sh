...
# 定义要执行的脚本列表（按顺序执行）
SCRIPTS=(
    "scripts/Arima/Arima_ECL.sh"
    "scripts/Arima/Arima_ETTh1.sh"
    "scripts/Arima/Arima_ETTh2.sh"
    "scripts/Arima/Arima_ETTm1.sh"
    "scripts/Arima/Arima_ETTm2.sh"
    "scripts/Arima/Arima_Exchange.sh"
    "scripts/Arima/Arima_Traffic.sh"
    "scripts/Arima/Arima_Weather.sh"
)
